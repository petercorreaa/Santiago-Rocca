  ...
  return (
    <SectionWrapper variant="dark" className="min-h-screen">
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-16 md:grid-cols-2 md:gap-24">
        ...
        {/* Columna izquierda — título + redes */}
        ...
        <Reveal delay={0.1}>
          {sent ? (
            <div className="flex h-full flex-col items-center justify-center gap-4 rounded-sm border border-accent/30 bg-ink-surface p-10 text-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <label htmlFor="nombre" className="label text-white/50">
                  Nombre *
                </label>
                <input
                  id="nombre"
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="email" className="label text-white/50">
                  Email *
                </label>
                <input
                  id="email"
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="mensaje" className="label text-white/50">
                  Mensaje *
                </label>
                <textarea
                  id="mensaje"
